                ...
                <div class="flex flex-col mt-8 break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="form-input font-mono text-sm w-full border mt-2 @error('email') border-red-500 @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                            @error('email')
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password-confirm" class="font-mono text-sm text-indigo-600 block uppercase">
                                {{ __('Confirm Password') }}:
                            </label>
