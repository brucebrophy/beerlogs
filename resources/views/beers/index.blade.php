		...
		<div class="row">
			<div class="lg:col-6">
				{!! Form::open(['route' => 'beers.index', 'method' => 'GET']) !!}
					<div class="flex mb-6">
						{{ Form::text('search', request()->get('search'), ['class' => 'form-input font-mono w-full border rounded-l-md border-r-0 rounded-r-none focus:border-indigo-600', 'placeholder' => 'Hazy State IPA']) }}
