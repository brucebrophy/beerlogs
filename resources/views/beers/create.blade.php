				...
				<div class="rounded-lg shadow-lg bg-white">
					...
					<div class="p-8">
						<label class="mb-5 font-mono text-indigo-600 block uppercase">
							Name
							<input name="name" class="form-input text-gray-700 w-full border mt-2 focus:border-indigo-600 " type="text" placeholder="Jelly King">
						</label>
						<label class="mb-5 font-mono text-indigo-600 block uppercase">
							Style
						...
						<label class="mb-5 font-mono text-indigo-600 block uppercase">
							Notes
							<input name="notes" class="form-input text-gray-700 w-full border mt-2 focus:border-indigo-600 " type="text" placeholder="An everyday, juicy, drinkable sour with punchy hop aromatics and fruity foundational flavours.">
						</label>
						<label class="mb-5 font-mono text-indigo-600 block uppercase">
							Description
