<navigation-component>
	...
	<template v-slot:main>
		{{-- <a href="#" class="px-3 py-2 rounded-md text-sm font-mono tracking-wider font-medium leading-5 text-white bg-indigo-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Dashboard</a> --}}
	...
	<template v-slot:profile>
		...
		@else
				<a href="#" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</a>
