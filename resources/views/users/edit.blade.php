	...
	<div class="container mx-auto">
		<div class="row">
			<div class="col-12 md:col-8 md:offset-2">
				<div class="rounded-lg overflow-hidden border border-gray-200 shadow-md bg-white">
					<div class="py-3 flex justify-center bg-indigo-600">
						<h4 class="font-mono text-white font-bold tracking-wider uppercase">User Details</h4>
					</div>
				...
				<div class="rounded-lg shadow-lg border border-red-600 bg-white mt-6">
					<div class="p-8">
						{!! Form::open(['route' => ['users.destroy', $user->username], 'method' => 'DELETE']) !!}
							{{ Form::label('name', 'Delete Account', ['class' => 'font-mono font-semibold text-red-600 block']) }}
